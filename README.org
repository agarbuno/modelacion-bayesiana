...
- [[#plan-de-trabajo-0150][Plan de trabajo [0/15][0%]​]]
  - [[#repaso][Repaso]]
  - [[#integración-numerica][Integración numerica]]
  - [[#mcmc-parte-1][MCMC (Parte 1)]]
  - [[#mcmc-parte-2][MCMC (Parte 2)]]
  - [[#hmc][HMC]]
  ...
  - [[#posterior-and-prior-predictive-checks][Posterior and prior predictive checks]]
  - [[#evaluation-and-cross-validation][Evaluation and cross validation]]
...
* Plan de trabajo [0/15][0%]                                         :github:
** TODO Repaso 
** TODO Integración numerica
** TODO MCMC (Parte 1)
** TODO MCMC (Parte 2)
** TODO HMC
** TODO Diagnosticos

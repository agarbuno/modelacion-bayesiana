...
#+caption: Métodos de objetos ~CmdStanModel~. 
#+attr_html: :width 1200 :align center
[[file:images/20220223-203257_screenshot.png]]


#+REVEAL: split
Por ejemplo, uno que pueda generar muestras del ~modelo probabilístico~ que se
...
cada escuela ~y~ y los errores estándar reportados ~sigma~.

...
[[https://mc-stan.org/docs/2_29/functions-reference/nbalt.html][Neg-Binom]]
...
[[https://discourse.mc-stan.org/t/negative-binomial-2-should-i-be-worried-about-metropolis-proposal-rejection-in-warmup-phase/5368][ayuda]]. 
...
1       lp__ -1689.6061 -1689.3100  0.95923  0.74130 -1691.5605 -1688.6600
2 log_lambda     4.0067     4.0065  0.03728  0.03861     3.9461     4.0674
3    log_phi     0.7889     0.7898  0.07535  0.07429     0.6616     0.9119
4        phi     2.2073     2.2029  0.16614  0.16402     1.9379     2.4890
5    y_tilde    54.9763    46.0000 38.51644 34.09980    10.0000   131.0000
...
#+RESULTS:
#+begin_src org
         compania promedio varianza
1  AirAsiaSupport    41.61   1718.4
2       AlaskaAir    83.59   1341.1
3 British_Airways    46.45    734.0
4         JetBlue    85.20    637.3
5   VirginAmerica    32.28    154.2
6  VirginAtlantic    36.44    185.9
#+end_src
...
#+begin_src stan :eval never :tangle ../modelos/reclamaciones/modelo-negbinom-jerarquico.stan
  ...
  transformed parameters {
    real phi[6];
    for (ii in 1:6)
      phi[ii] = exp(-log_phi[ii]);
  }

  model {
    log_lambda ~ normal(4, 0.5);
    log_phi    ~ normal(0, 0.5); 
...
#+begin_src org
        variable       mean     median       sd      mad         q5        q95
1           lp__ -1609.2470 -1608.9000  2.50209  2.35733 -1613.7700 -1605.7995
2  log_lambda[1]     4.4198     4.4186  0.07129  0.07046     4.3060     4.5371
3  log_lambda[2]     3.6042     3.6037  0.06542  0.06260     3.4994     3.7133
4  log_lambda[3]     3.8489     3.8487  0.09136  0.08988     3.7021     3.9995
5  log_lambda[4]     4.4400     4.4397  0.05683  0.05552     4.3479     4.5333
6  log_lambda[5]     3.4818     3.4814  0.05312  0.05265     3.3947     3.5688
7  log_lambda[6]     3.7567     3.7565  0.14283  0.13795     3.5236     3.9894
8     log_phi[1]    -1.2183    -1.2225  0.19652  0.19604    -1.5379    -0.8777
9     log_phi[2]    -1.5059    -1.5078  0.21774  0.21396    -1.8616    -1.1499
10    log_phi[3]    -0.7459    -0.7507  0.18661  0.18646    -1.0467    -0.4305
11    log_phi[4]    -1.7124    -1.7164  0.21783  0.21699    -2.0577    -1.3529
12    log_phi[5]    -1.9398    -1.9406  0.22909  0.23156    -2.3081    -1.5584
13    log_phi[6]    -0.1148    -0.1186  0.18975  0.18742    -0.4195     0.2096
14        phi[1]     3.4470     3.3958  0.67649  0.66600     2.4055     4.6549
15        phi[2]     4.6163     4.5167  1.01538  0.96339     3.1580     6.4340
16        phi[3]     2.1451     2.1185  0.40056  0.39304     1.5380     2.8484
17        phi[4]     5.6741     5.5642  1.23248  1.21907     3.8684     7.8283
18        phi[5]     7.1412     6.9632  1.64205  1.60129     4.7511    10.0553
19        phi[6]     1.1419     1.1259  0.21642  0.21243     0.8109     1.5211
20    y_tilde[1]    84.1642    76.0000 48.34948 44.47800    23.0000   173.0500
21    y_tilde[2]    37.0097    34.0000 19.07833 17.79120    11.0000    71.0000
22    y_tilde[3]    47.9062    40.0000 34.89723 29.65200     8.0000   117.0000
23    y_tilde[4]    84.9873    79.0000 39.01052 37.06500    33.0000   156.0000
24    y_tilde[5]    32.2597    31.0000 13.78391 13.34340    13.0000    58.0000
25    y_tilde[6]    44.1125    31.0000 43.40299 31.13460     2.0000   130.0000
     rhat ess_bulk ess_tail
1  1.0028     1893     2026
2  1.0020     7757     3032
3  0.9995     7985     2967

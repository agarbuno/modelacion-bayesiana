...
*Lectura recomendada*: Capítulo 7 de citep:Dogucu2021. Sección 6 de [[citep:Sanz-Alonso2019]] y Capítulo 3 de citep:Reich2015 (avanzado). 
#+END_NOTES
...
#+REVEAL: split
Una propiedad interesante es que el tiempo que el vendedor pase en cada isla
corresponderá al tamaño relativo de ellas. 
...
#+REVEAL: split
*Definición (~Invarianza~)* Decimos que la distribución $\pi$ es ~invariante~ para un
...
#+REVEAL: split
*Lemma (~Comportamiento asintótico de Metropolis-Hastings~)*. El mecanismo de MH
descrito anteriormente tiene como distribución límite $\pi$.\\

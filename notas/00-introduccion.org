...
- [[#motivación][Motivación]]
  ...
  - [[#por-qué-necesitamos-un-flujo-de-trabajo][¿Por qué necesitamos un flujo de trabajo?]]
    - [[#la-gente-de-ml-sabe-que-el-proceso-de-construcción-de-un-modelo-es-iterativo-por-qué-no-utilizarlo][La gente de ML sabe que el proceso de construcción de un modelo es iterativo, ¿por qué no utilizarlo?]]
- [[#notación][Notación]]

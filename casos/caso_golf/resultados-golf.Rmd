...
Este caso está basado en@GelmanNolan y @GolfCase. Usamos el flujo de trabajo
bayesiano tomado del documento de Michael Betancourt @BetancourtCase.
...
2. Tirar la pelota con una velocidad suficiente para llegue al hoyo pero no tan
alta que vuele por encima del hoyo.
...
- Esta curva puede variar dependiendo del jugador, pero vamos a modelar el
conjunto de tiros de profesionales. Suponemos homogeneidad que podríamos checar
con datos desagregados por jugador. Estos datos podrían tener
sobrerrepresentación de tiradores malos (que quizá hacen más tiros).
...
Usaremos datos de tiros de profesionales que incluyen la distancia al hoyo y si
el tiro fue exitoso o no.
